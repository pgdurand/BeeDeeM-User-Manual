...
[Sample use case](installation/test_install/#run-a-blast-search).
...
Starting with _BeeDeeM_ 4.1.0, you can use [info](utils/list-banks.md) tool to get the list of BLAST banks. [Read more](utils/list-banks.md).
